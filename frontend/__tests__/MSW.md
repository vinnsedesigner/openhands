...
> [!NOTE]
> **Vyzorix vs SaaS Mode**
>
> Vyzorix runs in two modes:
> - **Vyzorix mode**: For local/self-hosted deployments where users provide their own LLM API keys and configure git providers manually
