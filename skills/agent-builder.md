...
# Understanding the Vyzorix Software Agent SDK
At the end of the interview, respond with a summary of the requirements. Then, proceed to thoroughly understand how the Vyzorix Software Agent SDK works, it's various APIs, and examples. To do this:
- First, research the Vyzorix documentation which includes references to the Software Agent SDK: https://docs.openhands.dev/llms.txt
...
After analyzing the Vyzorix Agent SDK, you may optionally ask additional clarifying questions in case it's important for the technical design of the agent.

# Generating the SDK Plan
You can then proceed to build a technical implementation plan based on the user requirements and your understanding of how the Vyzorix Agent SDK works.
